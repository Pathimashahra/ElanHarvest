          ...
          <tbody className="bg-white divide-y divide-gray-50">
            {orders.length > 0 ? (
              orders.map((order) => (
                <tr key={order._id} className="hover:bg-green-50/20 transition duration-150 align-top">
                  ...
                  <td className="p-4 text-sm">
                    ...
                    {order.message && (
                      <div className="mt-2 text-xs bg-blue-50 border border-blue-200 text-blue-800 p-2 rounded-lg flex items-start gap-1">
              ...
              <tr>
                <td
                  colSpan="8"
                  className="text-center p-8 text-gray-600 text-sm"
                >
                  No Orders Found
                </td>
              </tr>
