...
<div className="border-t border-b py-4 my-4">
  <h2 className="font-bold text-lg text-green-700 mb-2">Order Summary</h2>
  <div className="space-y-1.5 text-sm text-gray-700">
    ...
    {payment === "Stripe" && (
      <div className="text-xs text-green-600 font-semibold italic">
...
className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-xl mt-5"
